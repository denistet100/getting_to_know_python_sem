...
letters_dict = {1: ['A', 'E', 'I', 'O', 'U', 'L', 'N', 'S', 'T', 'R', 'А', 'В', 'Е', 'И', 'Н', 'О', 'Р', 'С', 'Т'],
                2: ['D', 'G', 'Д', 'К', 'Л', 'М', 'П', 'У'], 3: ['B', 'C', 'M', 'P', 'Б', 'Г', 'Ё', 'Ь', 'Я'],
                4: ['F', 'H', 'V', 'W', 'Y', 'Й', 'Ы'], 5: ['K', 'Ж', 'З', 'Х', 'Ц', 'Ч'], 8: ['J', 'X', 'Ш', 'Э', 'Ю'],
                10: ['Q', 'Z', 'Ф', 'Щ', 'Ъ']}
print(letters_dict)

words = str(input('Введите слово на русском или английском:'))
count = 0


for value in range(len(words)):
    for key_1, value_1 in letters_dict.items():
        if words[value].upper() in value_1:
            count += key_1
